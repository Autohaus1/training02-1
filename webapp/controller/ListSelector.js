sap.ui.define([
	...
	return BaseObject.extend("de.integrata.training.flights.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias de.integrata.training.flights.model.ListSelector
		 */
		 ...
		 * @return {de.integrata.training.flights.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
